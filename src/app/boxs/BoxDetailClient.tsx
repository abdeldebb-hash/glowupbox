...
export type BoxDetail = {
  ...
  skinType: string; skinLabel: string; tag: string; accroche: string
  products: string[]; image: string | null; waMessage: string
}
...
const SUIVIS = [
  ...
  { icon: Star,          title: 'Fiche routine offerte',  desc: "Ordre d'application, fréquence conseillée et astuces." },
]

const TESTIMONIALS = [
  { text: '"J\'ai reçu ma box et le suivi WhatsApp a tout changé. Résultats visibles en 3 semaines !"', name: 'Sara M.',  meta: 'Casablanca' },
  { text: '"La recommandation était parfaitement adaptée à ma peau. Je recommande !"',                 name: 'Nadia B.', meta: 'Rabat' },
    ...
    <main>
      ...
      <section className="py-20 px-5 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[5fr_7fr] gap-12 items-start">
          <div className="rounded-3xl overflow-hidden aspect-[3/4] shadow-[0_24px_72px_rgba(26,26,46,.1)] relative group">
            <span className="absolute top-5 left-5 z-10 bg-brand-gradient text-white text-[9px] font-bold uppercase tracking-widest px-4 py-2 rounded-full">{box.skinLabel}</span>
      ...
      <div className="bg-brand-black">
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/7 max-w-6xl mx-auto">
          {[
            { title:'Produits soins',      items: box.products },
